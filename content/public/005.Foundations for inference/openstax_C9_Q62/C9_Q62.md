  ...
  substitutions:
    params:
      ...
      part2:
        statement1:
          value: Type I Error
          matches: We conclude that the mean μ is more than 6, when it really is 6
            or less.
        statement2:
          value: Type II Error
          matches: We conclude that the mean μ is 6 or less, when in fact it is more
            than 6.
      question_text: The mean number of weeks of paid vacation time for Europeans
        each year is more than 6
---
# {{ params.vars.title }}
