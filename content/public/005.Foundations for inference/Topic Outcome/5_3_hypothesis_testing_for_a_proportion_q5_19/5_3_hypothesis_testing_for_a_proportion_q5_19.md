  ...
  substitutions:
    params:
      ...
      part2:
        num1: 68
        ans1:
          value: Yes, the claim is supported since 68% is greater than the lower limit
            of the confidence interval.
          feedback: Try again please!
        ans2:
          value: Yes, the claim is supported because the upper limit of the confidence
            interval is 61%, which is close to 68%.
          feedback: Try again please!
        ans3:
          value: No, the claim is not supported since 68% falls outside the confidence
            interval.
          feedback: Correct! The value of 68% lies outside of the interval, so we
      ...
      part3:
        ...
        ans3:
          ...
          feedback: Correct! A 90% confidence interval will be narrower than a 95%
            ...
            that 68% would not fall in the interval, and we would reject the researcher's
      ...
      part1:
        ...
        ans2:
          value: Yes, the claim is supported, but only because the interval is above
            52%, not necessarily indicating a majority.
          feedback: Try again please!
        ans3:
