    ...
    params:
      ...
      part4:
        ans1:
          ...
          feedback: Try again please!
        ans2:
          value: '$H_A: \mu \lt 3971.7$'
          feedback: Correct!
        ans3:
          value: '$H_A: \mu \le 3971.7$'
          feedback: Typically the equality is captured in the null hypothesis
        ans4:
          value: '$H_0: \mu \lt 3971.7$'
          feedback: Pay attention to the subscript of H
        ans5:
          value: '$H_A: \bar{x} \lt 3971.7$'
          feedback: The hypothesis should be stated in terms of population parameters
      part5:
        ans1:
          value: $1.282$
      ...
      part6:
        ans1:
          ...
          feedback: Correct!
        ans2:
          value: $\operatorname{N}(3971.7, 971)$
          feedback: Try again please!
        ans3:
          value: $\operatorname{N}(3971.7, 971/\sqrt{12})$
          feedback: Try again please!
        ans4:
          value: $t_{n-1}$
          feedback: Try again please!
      ...
      part11:
        ans1:
          value: There is sufficient evidence to suggest that the average caloric
            intake of elite male athletes is less than 3971.7 kcal/d.
          feedback: Correct!
        ans2:
          value: There is sufficient evidence to suggest that the average caloric
            intake of elite male athletes is different than 3971.7 kcal/d.
          feedback: Please try again.
        ans3:
        ...
        ans4:
          value: There is sufficient evidence to prove that the average caloric intake
            of elite male athletes is less than 3971.7 kcal/d.
          feedback: Please try again.
---
# {{ params.vars.title }}
