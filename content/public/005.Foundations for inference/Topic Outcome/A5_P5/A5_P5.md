...
myst:
  substitutions:
    ...
    params_part6_ans2_value: $\operatorname{N}(3830.2, 904)$
    params_part6_ans2_feedback: Try again please!
    params_part6_ans3_value: $\operatorname{N}(3830.2, 904/\sqrt{12})$
    ...
    params_part11_ans1_value: There is sufficient evidence to suggest that the average
      caloric intake of elite male athletes is less than 3830.2 kcal/d.
    ...
    params_part11_ans2_value: There is sufficient evidence to suggest that the average
      caloric intake of elite male athletes is different than 3830.2 kcal/d.
