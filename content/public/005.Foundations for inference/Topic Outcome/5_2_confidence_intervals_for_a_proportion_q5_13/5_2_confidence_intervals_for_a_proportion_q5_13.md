...
myst:
  substitutions:
    ...
    params_part3_ans1_value: The 90% confidence interval is approximately (0.0614,
      0.0872). We are 90% confident that the true proportion of all first-time visitors
      who would register under the new design is between 6.14% and 8.72%.
