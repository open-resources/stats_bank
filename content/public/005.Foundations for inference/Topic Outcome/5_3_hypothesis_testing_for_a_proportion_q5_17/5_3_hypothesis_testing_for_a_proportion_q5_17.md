...
myst:
  substitutions:
    ...
    params_description_sample_size: 168
    params_description_num2: 0.57
    params_description_num3: 0.63
    params_description_num4: 57
    params_description_num5: 63
    ...
    params_part1_ans1_feedback: Correct! (1) The hypotheses should be about the population
      ...
      sample proportion.
    params_part1_ans2_value: ' $H_0: p < 0.63$, $H_A: p > 0.57$ (Your friend''s proposed
