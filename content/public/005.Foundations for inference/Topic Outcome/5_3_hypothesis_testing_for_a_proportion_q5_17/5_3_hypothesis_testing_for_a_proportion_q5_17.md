...
myst:
  substitutions:
    params:
      ...
      part1:
        ans1:
          value: $H_0$ should be $p = 0.6$ (Null hypothesis should state that the
            population proportion is equal to 0.6.)
          feedback: Correct! (1) The hypotheses should be about the population proportion
            ...
            sign, and, (4) It should reference the null value, $p_0$ = 0.6, not the
            observed sample proportion.
        ans2:
          value: ' $H_0: p < 0.68$, $H_A: p > 0.6$ (Your friend''s proposed hypotheses
