...
myst:
  substitutions:
    ...
    params_description_sample_size: 144
    params_description_num2: 0.66
    params_description_num3: 0.69
    params_description_num4: 66
    params_description_num5: 69
    params_part1_ans1_value: $H_0$ should be $p = 0.66$ (Null hypothesis should state
      that the population proportion is equal to 0.66.)
    params_part1_ans1_feedback: Correct! (1) The hypotheses should be about the population
      ...
      sign, and, (4) It should reference the null value, $p_0$ = 0.66, not the observed
      sample proportion.
    params_part1_ans2_value: ' $H_0: p < 0.69$, $H_A: p > 0.66$ (Your friend''s proposed
