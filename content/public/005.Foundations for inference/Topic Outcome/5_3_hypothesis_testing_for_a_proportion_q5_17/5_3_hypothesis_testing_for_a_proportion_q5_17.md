...
myst:
  substitutions:
    ...
    params_description_sample_size: 170
    params_description_num2: 0.54
    params_description_num3: 0.75
    params_description_num4: 54
    params_description_num5: 75
    ...
    params_part1_ans1_feedback: Correct! (1) The hypotheses should be about the population
      ...
      sample proportion.
    params_part1_ans2_value: ' $H_0: p < 0.75$, $H_A: p > 0.54$ (Your friend''s proposed
