...
myst:
  substitutions:
    ...
    params_description_sample_size: 172
    params_description_num2: 0.65
    params_description_num3: 0.72
    params_description_num4: 65
    params_description_num5: 72
    ...
    params_part1_ans1_feedback: Correct! (1) The hypotheses should be about the population
      ...
      sample proportion.
    params_part1_ans2_value: ' $H_0: p < 0.72$, $H_A: p > 0.65$ (Your friend''s proposed
