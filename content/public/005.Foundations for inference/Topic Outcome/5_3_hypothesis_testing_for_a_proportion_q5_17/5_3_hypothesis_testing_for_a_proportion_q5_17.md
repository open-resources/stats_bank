...
myst:
  substitutions:
    ...
    params_description_sample_size: 148
    params_description_num2: 0.56
    params_description_num3: 0.64
    params_description_num4: 56
    params_description_num5: 64
    ...
    params_part1_ans1_feedback: Correct! (1) The hypotheses should be about the population
      ...
      sample proportion.
    params_part1_ans2_value: ' $H_0: p < 0.64$, $H_A: p > 0.56$ (Your friend''s proposed
