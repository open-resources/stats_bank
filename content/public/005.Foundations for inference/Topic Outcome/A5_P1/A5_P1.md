...
myst:
  substitutions:
    ...
    params_endsize: 51
    params_exceed: 13
    params_totaltime: 893
    params_part1_ans1_value: $Exponential(\lambda = 1/15)$
    ...
    params_part1_ans3_value: $Normal(15, 15)$
    params_part1_ans3_feedback: Please try again.
    params_part1_ans4_value: $Normal(1/15, 1/15)$
    params_part1_ans4_feedback: Please try again.
    params_part1_ans5_value: $Normal(15, 15/\sqrt{50})$
