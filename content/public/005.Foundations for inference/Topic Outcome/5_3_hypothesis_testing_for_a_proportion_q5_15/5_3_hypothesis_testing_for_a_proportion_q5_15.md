...
myst:
  substitutions:
    params:
      ...
      part3:
        ans1:
          value: '$H_0: \mu \neq 30$ The average amount of company time each employee
            spends not working is different during March Madness.'
          feedback: Try again please!
        ans2:
          value: '$H_0: \mu > 30$ The average amount of company time each employee
      ...
      part4:
        ans1:
          value: '$H_A: \mu = 30$ The average amount of company time each employee
            spends not working is the same during March Madness.'
          feedback: Try again please!
        ans2:
          value: '$H_A: \mu > 30$ The average amount of company time each employee
