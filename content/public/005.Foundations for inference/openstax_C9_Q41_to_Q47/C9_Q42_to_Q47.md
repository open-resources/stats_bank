    ...
    params:
      ...
      part2:
        ...
        ans3:
          ...
          feedback: Try Again!
        ans4:
          value: The mean time spent in jail for 1.1 first time convicted burglars.
          feedback: Try Again!
      part7:
        ans1:
          value: $\operatorname{N}(1.25, \frac{ 1.25 }{\sqrt{ 12.5 } })$
          feedback: Try Again!
        ans2:
          value: $\operatorname{N}(2.5, \frac{ 1.1 }{\sqrt{ 25 } })$
          feedback: You got it!
        ans3:
          value: $\operatorname{B}(2.5, \frac{ 2.5 }{\sqrt{ 25 } })$
          feedback: Try Again!
        ans4:
