...
myst:
  substitutions:
    params:
      ...
      part2:
        ans1:
          value: The mean time spent in jail for 2.8 first time convicted burglars.
          feedback: You got it!
        ans2:
          value: The total time spent in jail for first time convicted burglars.
          feedback: Try Again!
        ans3:
          value: The proportion of the time spent in jail for 2.8 first time convicted
            burglars.
          feedback: Try Again!
        ans4:
      ...
      part7:
        ans1:
          value: $\operatorname{N}(1.4, \frac{1.4}{\sqrt{16.5}})$
          feedback: Try Again!
        ans2:
          value: $\operatorname{N}(2.8, \frac{1.6}{\sqrt{33}})$
          feedback: You got it!
        ans3:
          value: $\operatorname{B}(2.8, \frac{2.8}{\sqrt{33}})$
          feedback: Try Again!
        ans4:
