    ...
    params:
      ...
      part2:
        ...
        ans3:
          ...
          feedback: Try Again!
        ans4:
          value: The mean time spent in jail for 1.3 first time convicted burglars.
          feedback: Try Again!
      part7:
        ans1:
          value: $\operatorname{N}(1.25, \frac{ 1.25 }{\sqrt{ 17.0 } })$
          feedback: Try Again!
        ans2:
          value: $\operatorname{N}(2.5, \frac{ 1.3 }{\sqrt{ 34 } })$
          feedback: You got it!
        ans3:
          value: $\operatorname{B}(2.5, \frac{ 2.5 }{\sqrt{ 34 } })$
          feedback: Try Again!
        ans4:
