    ...
    params:
      ...
      part2:
        ...
        ans3:
          ...
          feedback: Try Again!
        ans4:
          value: The mean time spent in jail for 1.5 first time convicted burglars.
          feedback: Try Again!
      part7:
        ans1:
          value: $\operatorname{N}(1.25, \frac{ 1.25 }{\sqrt{ 14.0 } })$
          feedback: Try Again!
        ans2:
          value: $\operatorname{N}(2.5, \frac{ 1.5 }{\sqrt{ 28 } })$
          feedback: You got it!
        ans3:
          value: $\operatorname{B}(2.5, \frac{ 2.5 }{\sqrt{ 28 } })$
          feedback: Try Again!
        ans4:
