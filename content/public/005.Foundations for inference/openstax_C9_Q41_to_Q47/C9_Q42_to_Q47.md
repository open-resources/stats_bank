    ...
    params:
      ...
      part2:
        ...
        ans3:
          ...
          feedback: Try Again!
        ans4:
          value: The mean time spent in jail for 1.2 first time convicted burglars.
          feedback: Try Again!
      part7:
        ans1:
          value: $\operatorname{N}(1.25, \frac{1.25}{\sqrt{16.5}})$
          feedback: Try Again!
        ans2:
          value: $\operatorname{N}(2.5, \frac{1.2}{\sqrt{33}})$
          feedback: You got it!
        ans3:
          value: $\operatorname{B}(2.5, \frac{2.5}{\sqrt{33}})$
          feedback: Try Again!
        ans4:
