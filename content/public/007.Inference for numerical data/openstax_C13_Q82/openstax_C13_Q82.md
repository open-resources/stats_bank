  ...
  substitutions:
    params:
      ...
      anova_table: |-
        ...
        <td><pl-number-input answers-name="part2_between_ss_value" correct-answer="36.4579" show-help-text="false" size="10" display="block" comparison="decdig" digits="4" weight="1"></pl-number-input></td>
        ...
        <td><pl-number-input answers-name="part2_between_ms_value" correct-answer="12.1526" show-help-text="false" size="10" display="block" comparison="decdig" digits="4" weight="1"></pl-number-input></td>
        <td><pl-number-input answers-name="part2_between_f_value" correct-answer="37.0654" show-help-text="false" size="10" display="block" comparison="decdig" digits="4" weight="1"></pl-number-input></td>
        </tr><tr>
        <th>Within Groups</th>
        <td><pl-number-input answers-name="part2_within_ss_value" correct-answer="7.8689" show-help-text="false" size="10" display="block" comparison="decdig" digits="4" weight="1"></pl-number-input></td>
        ...
        <td><pl-number-input answers-name="part2_within_ms_value" correct-answer="0.3279" show-help-text="false" size="10" display="block" comparison="decdig" digits="4" weight="1"></pl-number-input></td>
        <td></td>
        </tr><tr>
        <th>Total</th>
        <td><pl-number-input answers-name="part2_total_ss_value" correct-answer="44.3268" show-help-text="false" size="10" display="block" comparison="decdig" digits="4" weight="1"></pl-number-input></td>
