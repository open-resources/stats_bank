...
myst:
  substitutions:
    ...
    params_vars_unit2: g
    params_vars_problem_statement: height (ft) from weight (g)
    ...
    params_part1_option3_value: $\frac{ft}{g}$
    params_part1_option3_name: Slope
    params_part1_option4_value: $g$
    params_part1_option4_name: Distractor 1
    params_part1_option5_value: $\frac{g}{ft}$
