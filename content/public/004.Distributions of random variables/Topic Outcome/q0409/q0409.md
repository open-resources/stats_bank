...
myst:
  substitutions:
    params:
      ...
      temp: 77
      percent: 20
      z: 0.14285714285714285
      prob: 0.4432
      mu_C: 24.444444444444443
      sig_C: 3.888888888888889
      temp_C_f: 25.0
      temp_C: 25
      z_C: 0.14285714285714327
      prob_C: 0.4432015031835317
      IQR_C: 5.246
      part4:
        ans1:
          value: 'No'
          feedback: The answers are very close because only the units were changed.
            (The only reason why they differ at all because 77 F is 25.0 C, not precisely
            25 C.)
        ans2:
          value: 'Yes'
          feedback: The answers are very close because only the units were changed.
