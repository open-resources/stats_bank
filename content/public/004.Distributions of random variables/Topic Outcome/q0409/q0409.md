...
myst:
  substitutions:
    ...
    params_temp: 85
    params_percent: 28
    params_z: 0.42857142857142855
    params_prob: 0.3341
    params_mu_C: 27.77777777777778
    params_sig_C: 3.888888888888889
    params_temp_C_f: 29.444444444444443
    params_temp_C: 29
    params_z_C: 0.3142857142857141
    params_prob_C: 0.37665202364295625
    params_IQR_C: 5.246
    params_part4_ans1_value: 'No'
    params_part4_ans1_feedback: The answers are very close because only the units
      were changed. (The only reason why they differ at all because 85 F is 29.444
      C, not precisely 29 C.)
