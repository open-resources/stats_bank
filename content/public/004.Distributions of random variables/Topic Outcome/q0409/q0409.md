...
myst:
  substitutions:
    params:
      ...
      z: 0.2
      prob: 0.4207
      mu_C: 23.88888888888889
      sig_C: 2.7777777777777777
      temp_C_f: 24.444444444444443
      temp_C: 24
      z_C: 0.03999999999999986
      prob_C: 0.4840465631471693
      IQR_C: 3.747
      part4:
        ans1:
          value: 'No'
          feedback: The answers are very close because only the units were changed.
            (The only reason why they differ at all because 76 F is 24.444 C, not
            precisely 24 C.)
        ans2:
          value: 'Yes'
          feedback: The answers are very close because only the units were changed.
