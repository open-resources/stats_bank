...
myst:
  substitutions:
    params:
      ...
      temp: 78
      percent: 8
      z: 0.8571428571428571
      prob: 0.1957
      mu_C: 22.22222222222222
      sig_C: 3.888888888888889
      temp_C_f: 25.555555555555557
      temp_C: 26
      z_C: 0.9714285714285716
      prob_C: 0.1656674532515663
      IQR_C: 5.246
      part4:
        ans1:
          value: 'No'
          feedback: The answers are very close because only the units were changed.
            (The only reason why they differ at all because 78 F is 25.556 C, not
            precisely 26 C.)
        ans2:
          value: 'Yes'
          feedback: The answers are very close because only the units were changed.
