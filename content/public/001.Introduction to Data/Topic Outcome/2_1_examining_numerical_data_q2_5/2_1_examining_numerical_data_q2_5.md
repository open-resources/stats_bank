    ...
    params:
      ...
      part1:
        ...
        statement2:
          value: Sample mean
          matches: '4.15'
      question1: The average GPA of students in 2001 at a private university was 2.91.
        A survey on a sample of 174 students from this university yielded an average
        GPA of 4.15 a decade later.
---
# {{ params.vars.title }}
