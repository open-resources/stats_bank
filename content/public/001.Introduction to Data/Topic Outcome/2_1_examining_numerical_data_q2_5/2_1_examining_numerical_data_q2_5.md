    ...
    params:
      ...
      part1:
        ...
        statement2:
          value: Sample mean
          matches: '4.36'
      question1: The average GPA of students in 2001 at a private university was 2.87.
        A survey on a sample of 296 students from this university yielded an average
        GPA of 4.36 a decade later.
---
# {{ params.vars.title }}
