    ...
    params:
      ...
      part1:
        ...
        statement2:
          value: Sample mean
          matches: '4.07'
      question1: The average GPA of students in 2001 at a private university was 3.36.
        A survey on a sample of 298 students from this university yielded an average
        GPA of 4.07 a decade later.
---
# {{ params.vars.title }}
