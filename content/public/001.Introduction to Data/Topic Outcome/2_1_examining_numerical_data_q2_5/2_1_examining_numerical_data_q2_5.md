...
myst:
  substitutions:
    ...
    params_part1_option2_value: 186
    params_part1_option3_value: 10
    params_part1_statement1_value: Claimed population mean
    params_part1_statement1_matches: '3.9'
    params_part1_statement2_value: Sample mean
    params_part1_statement2_matches: '4.32'
    params_question1: The average GPA of students in 2001 at a private university
      was 3.9. A survey on a sample of 186 students from this university yielded an
      average GPA of 4.32 a decade later.
---
# {{ params_vars_title }}
