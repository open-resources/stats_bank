    ...
    params:
      ...
      part1:
        ...
        statement2:
          value: Sample mean
          matches: '3.63'
      question1: The average GPA of students in 2001 at a private university was 3.71.
        A survey on a sample of 219 students from this university yielded an average
        GPA of 3.63 a decade later.
---
# {{ params.vars.title }}
