    ...
    params:
      ...
      part1:
        ...
        statement2:
          value: Sample mean
          matches: '3.84'
      question1: The average GPA of students in 2001 at a private university was 3.95.
        A survey on a sample of 205 students from this university yielded an average
        GPA of 3.84 a decade later.
---
# {{ params.vars.title }}
