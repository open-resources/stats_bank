    ...
    params:
      ...
      part1:
        ...
        statement2:
          value: Sample mean
          matches: '4.25'
      question1: The average GPA of students in 2001 at a private university was 3.98.
        A survey on a sample of 164 students from this university yielded an average
        GPA of 4.25 a decade later.
---
# {{ params.vars.title }}
