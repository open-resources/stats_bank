    ...
    params:
      ...
      part1:
        ...
        statement2:
          value: Sample mean
          matches: '3.55'
      question1: The average GPA of students in 2001 at a private university was 2.98.
        A survey on a sample of 249 students from this university yielded an average
        GPA of 3.55 a decade later.
---
# {{ params.vars.title }}
