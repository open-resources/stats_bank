...
myst:
  substitutions:
    ...
    params_part1_statement1_matches: '3.81'
    params_part1_statement2_value: Sample mean
    params_part1_statement2_matches: '4.11'
    params_question1: The average GPA of students in 2001 at a private university
      was 3.81. A survey on a sample of 261 students from this university yielded
      an average GPA of 4.11 a decade later.
---
# {{ params_vars_title }}
