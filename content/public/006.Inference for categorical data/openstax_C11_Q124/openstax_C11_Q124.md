...
myst:
  substitutions:
    params:
      ...
      part3:
        ans1:
          value: '$H_0: \sigma = 3.5$, $H_A: \sigma > 3.5$'
          feedback: Good Job!
        ans2:
          value: '$H_0: \sigma = 3.5$, $H_A: \sigma < 3.5$'
          feedback: Try again.
        ans3:
          value: '$H_0: \sigma = 3.5$, $H_A: \sigma \neq 3.5$'
          feedback: Try again.
        ans4:
          value: '$H_0: \sigma^2 = 3.5$, $H_A: \sigma^2 > 3.5$'
          feedback: Try again.
        ans5:
          value: '$H_0: \sigma^2 = 3.5$, $H_A: \sigma^2 < 3.5$'
          feedback: Try again.
        ans6:
          value: '$H_0: \sigma^2 = 3.5$, $H_A: \sigma^2 \neq 3.5$'
          feedback: Try again.
        ans7:
          value: '$H_0: \sigma = 12$, $H_A: \sigma > 12$'
          feedback: Try again.
        ans8:
          value: '$H_0: \sigma = 12$, $H_A: \sigma < 12$'
          feedback: Try again.
        ans9:
          value: '$H_0: \sigma = 12$, $H_A: \sigma \neq 12$'
          feedback: Try again.
