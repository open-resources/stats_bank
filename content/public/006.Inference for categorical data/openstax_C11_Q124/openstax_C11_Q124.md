...
myst:
  substitutions:
    params:
      ...
      part3:
        ans1:
          value: '$H_0: \sigma = 2.4$, $H_A: \sigma > 2.4$'
          feedback: Good Job!
        ans2:
          value: '$H_0: \sigma = 2.4$, $H_A: \sigma < 2.4$'
          feedback: Try again.
        ans3:
          value: '$H_0: \sigma = 2.4$, $H_A: \sigma \neq 2.4$'
          feedback: Try again.
        ans4:
          value: '$H_0: \sigma^2 = 2.4$, $H_A: \sigma^2 > 2.4$'
          feedback: Try again.
        ans5:
          value: '$H_0: \sigma^2 = 2.4$, $H_A: \sigma^2 < 2.4$'
          feedback: Try again.
        ans6:
          value: '$H_0: \sigma^2 = 2.4$, $H_A: \sigma^2 \neq 2.4$'
          feedback: Try again.
        ans7:
          value: '$H_0: \sigma = 6$, $H_A: \sigma > 6$'
          feedback: Try again.
        ans8:
          value: '$H_0: \sigma = 6$, $H_A: \sigma < 6$'
          feedback: Try again.
        ans9:
          value: '$H_0: \sigma = 6$, $H_A: \sigma \neq 6$'
          feedback: Try again.
