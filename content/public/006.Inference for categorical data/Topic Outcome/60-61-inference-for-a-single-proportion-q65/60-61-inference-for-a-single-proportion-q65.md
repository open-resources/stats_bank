  ...
  substitutions:
    params:
      vars:
        ...
        lower_bound: 24.86
        upper_bound: 29.14
        margin_of_error_part4: 1.069
        selected_option1: If we considered many random samples of 1657 Americans,
        ...
        selected_option2: In order to decrease the margin of error to 0.02137618251637398%,
