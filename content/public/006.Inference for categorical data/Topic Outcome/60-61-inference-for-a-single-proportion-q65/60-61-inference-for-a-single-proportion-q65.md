...
myst:
  substitutions:
    ...
    params_vars_margin_of_error: 2.29
    params_vars_lower_bound: 59.71
    params_vars_upper_bound: 64.29
    params_vars_margin_of_error_part4: 1.144
    params_vars_selected_option1: If we considered many random samples of 1729 Americans,
