...
myst:
  substitutions:
    ...
    params_vars_sample_size: 1396
    params_vars_proportion: 73.0
    params_vars_margin_of_error: 2.33
    params_vars_lower_bound: 70.67
    params_vars_upper_bound: 75.33
    params_vars_margin_of_error_part4: 1.164
    params_vars_selected_option1: If we considered many random samples of 1396 Americans,
    ...
    params_vars_selected_option2: In order to decrease the margin of error to 0.023288884874758404%,
