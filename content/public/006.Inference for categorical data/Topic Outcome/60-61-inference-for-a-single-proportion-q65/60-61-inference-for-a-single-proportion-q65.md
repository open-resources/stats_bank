...
myst:
  substitutions:
    ...
    params_vars_sample_size: 1714
    params_vars_proportion: 69.0
    params_vars_margin_of_error: 2.19
    params_vars_lower_bound: 66.81
    params_vars_upper_bound: 71.19
    params_vars_margin_of_error_part4: 1.095
    ...
    params_vars_selected_option2: In order to decrease the margin of error to 0.021895157546957967%,
