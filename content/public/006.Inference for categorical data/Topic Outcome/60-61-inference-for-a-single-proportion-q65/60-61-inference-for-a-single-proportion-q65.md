...
myst:
  substitutions:
    ...
    params_vars_sample_size: 1819
    params_vars_proportion: 84.0
    params_vars_margin_of_error: 1.68
    params_vars_lower_bound: 82.32
    params_vars_upper_bound: 85.68
    params_vars_margin_of_error_part4: 0.842
