...
myst:
  substitutions:
    ...
    params_vars_sample_size: 1971
    params_vars_proportion: 82.0
    params_vars_margin_of_error: 1.7
    params_vars_lower_bound: 80.3
    params_vars_upper_bound: 83.7
    params_vars_margin_of_error_part4: 0.848
    ...
    params_vars_selected_option2: In order to decrease the margin of error to 0.016960863446641893%,
