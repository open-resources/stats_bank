...
myst:
  substitutions:
    ...
    params_vars_sample_size: 1292
    params_vars_proportion: 49.0
    params_vars_margin_of_error: 2.73
    params_vars_lower_bound: 46.27
    params_vars_upper_bound: 51.73
    params_vars_margin_of_error_part4: 1.363
