...
myst:
  substitutions:
    ...
    params_vars_sample_size: 1580
    params_vars_proportion: 49.0
    params_vars_margin_of_error: 2.46
    params_vars_lower_bound: 46.54
    params_vars_upper_bound: 51.46
    params_vars_margin_of_error_part4: 1.232
    params_vars_selected_option1: If we considered many random samples of 1580 Americans,
