...
myst:
  substitutions:
    ...
    params_vars_sample_size: 1861
    params_vars_proportion: 64.0
    params_vars_margin_of_error: 2.18
    params_vars_lower_bound: 61.82
    params_vars_upper_bound: 66.18
    params_vars_margin_of_error_part4: 1.09
    ...
    params_vars_selected_option2: In order to decrease the margin of error to 0.02180801523214241%,
