...
myst:
  substitutions:
    ...
    params_vars_sample_size: 1936
    params_vars_proportion: 79.0
    params_vars_margin_of_error: 1.81
    params_vars_lower_bound: 77.19
    params_vars_upper_bound: 80.81
    params_vars_margin_of_error_part4: 0.907
