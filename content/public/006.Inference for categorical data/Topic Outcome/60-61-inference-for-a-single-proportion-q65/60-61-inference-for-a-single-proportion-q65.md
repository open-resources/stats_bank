...
myst:
  substitutions:
    ...
    params_vars_sample_size: 1398
    params_vars_proportion: 88.0
    params_vars_margin_of_error: 1.7
    params_vars_lower_bound: 86.3
    params_vars_upper_bound: 89.7
    params_vars_margin_of_error_part4: 0.852
    params_vars_selected_option1: If we considered many random samples of 1398 Americans,
    ...
    params_vars_selected_option2: In order to decrease the margin of error to 0.01703438522571616%,
