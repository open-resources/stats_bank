  ...
  substitutions:
    params:
      vars:
        ...
        lower_bound: 29.44
        upper_bound: 34.56
        margin_of_error_part4: 1.279
        selected_option1: If we considered many random samples of 1278 Americans,
        ...
        selected_option2: In order to decrease the margin of error to 0.025574791961378584%,
