...
myst:
  substitutions:
    ...
    params_vars_sample_size: 1021
    params_vars_proportion: 66.0
    params_vars_margin_of_error: 2.91
    params_vars_lower_bound: 63.09
    params_vars_upper_bound: 68.91
    params_vars_margin_of_error_part4: 1.453
