...
myst:
  substitutions:
    ...
    params_vars_sample_size: 1637
    params_vars_proportion: 65.0
    params_vars_margin_of_error: 2.31
    params_vars_lower_bound: 62.69
    params_vars_upper_bound: 67.31
    params_vars_margin_of_error_part4: 1.155
    ...
    params_vars_selected_option2: In order to decrease the margin of error to 0.02310545109528008%,
