...
myst:
  substitutions:
    ...
    params_vars_sample_size: 1291
    params_vars_proportion: 23.0
    params_vars_margin_of_error: 2.3
    params_vars_lower_bound: 20.7
    params_vars_upper_bound: 25.3
    params_vars_margin_of_error_part4: 1.148
    params_vars_selected_option1: If we considered many random samples of 1291 Americans,
