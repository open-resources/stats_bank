...
myst:
  substitutions:
    ...
    params_vars_sample_size: 1874
    params_vars_proportion: 39.0
    params_vars_margin_of_error: 2.21
    params_vars_lower_bound: 36.79
    params_vars_upper_bound: 41.21
    params_vars_margin_of_error_part4: 1.104
