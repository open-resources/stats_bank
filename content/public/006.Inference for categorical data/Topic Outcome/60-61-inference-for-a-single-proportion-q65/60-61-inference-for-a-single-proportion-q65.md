...
myst:
  substitutions:
    ...
    params_vars_sample_size: 1177
    params_vars_proportion: 20.0
    params_vars_margin_of_error: 2.29
    params_vars_lower_bound: 17.71
    params_vars_upper_bound: 22.29
    params_vars_margin_of_error_part4: 1.143
