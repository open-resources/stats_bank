...
myst:
  substitutions:
    ...
    params_vars_sample_size: 1152
    params_vars_proportion: 43.0
    params_vars_margin_of_error: 2.86
    params_vars_lower_bound: 40.14
    params_vars_upper_bound: 45.86
    params_vars_margin_of_error_part4: 1.429
