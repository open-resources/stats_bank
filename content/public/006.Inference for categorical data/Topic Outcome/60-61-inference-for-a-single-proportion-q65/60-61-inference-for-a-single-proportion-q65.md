...
myst:
  substitutions:
    ...
    params_vars_sample_size: 1374
    params_vars_proportion: 73.0
    params_vars_margin_of_error: 2.35
    params_vars_lower_bound: 70.65
    params_vars_upper_bound: 75.35
    params_vars_margin_of_error_part4: 1.174
    params_vars_selected_option1: If we considered many random samples of 1374 Americans,
