...
myst:
  substitutions:
    ...
    params_vars_sample_size: 1970
    params_vars_proportion: 83.0
    params_vars_margin_of_error: 1.66
    params_vars_lower_bound: 81.34
    params_vars_upper_bound: 84.66
    params_vars_margin_of_error_part4: 0.829
    params_vars_selected_option1: If we considered many random samples of 1970 Americans,
    ...
    params_vars_selected_option2: In order to decrease the margin of error to 0.01658740638431294%,
