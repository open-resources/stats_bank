...
myst:
  substitutions:
    ...
    params_vars_sample_size: 1345
    params_vars_proportion: 33.0
    params_vars_margin_of_error: 2.51
    params_vars_lower_bound: 30.49
    params_vars_upper_bound: 35.51
    params_vars_margin_of_error_part4: 1.256
