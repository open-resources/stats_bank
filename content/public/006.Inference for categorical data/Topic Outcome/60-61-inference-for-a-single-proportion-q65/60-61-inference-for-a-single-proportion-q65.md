...
myst:
  substitutions:
    ...
    params_vars_sample_size: 1090
    params_vars_proportion: 83.0
    params_vars_margin_of_error: 2.23
    params_vars_lower_bound: 80.77
    params_vars_upper_bound: 85.23
    params_vars_margin_of_error_part4: 1.115
    params_vars_selected_option1: If we considered many random samples of 1090 Americans,
