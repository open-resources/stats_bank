...
myst:
  substitutions:
    ...
    params_vars_sample_size: 1276
    params_vars_proportion: 47.0
    params_vars_margin_of_error: 2.74
    params_vars_lower_bound: 44.26
    params_vars_upper_bound: 49.74
    params_vars_margin_of_error_part4: 1.369
    params_vars_selected_option1: If we considered many random samples of 1276 Americans,
