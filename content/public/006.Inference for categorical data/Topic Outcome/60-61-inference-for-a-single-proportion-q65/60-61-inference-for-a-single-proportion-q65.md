...
myst:
  substitutions:
    ...
    params_vars_sample_size: 1791
    params_vars_proportion: 26.0
    params_vars_margin_of_error: 2.03
    params_vars_lower_bound: 23.97
    params_vars_upper_bound: 28.03
    params_vars_margin_of_error_part4: 1.016
