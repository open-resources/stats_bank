...
myst:
  substitutions:
    ...
    params_vars_sample_size: 1076
    params_vars_proportion: 84.0
    params_vars_margin_of_error: 2.19
    params_vars_lower_bound: 81.81
    params_vars_upper_bound: 86.19
    ...
    params_vars_selected_option2: In order to decrease the margin of error to 0.02190491587943707%,
