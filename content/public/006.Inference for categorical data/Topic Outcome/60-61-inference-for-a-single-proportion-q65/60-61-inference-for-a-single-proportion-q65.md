...
myst:
  substitutions:
    ...
    params_vars_sample_size: 1183
    params_vars_proportion: 87.0
    params_vars_margin_of_error: 1.92
    params_vars_lower_bound: 85.08
    params_vars_upper_bound: 88.92
    params_vars_margin_of_error_part4: 0.958
