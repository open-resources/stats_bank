...
myst:
  substitutions:
    ...
    params_vars_sample_size: 1639
    params_vars_proportion: 83.0
    params_vars_margin_of_error: 1.82
    params_vars_lower_bound: 81.18
    params_vars_upper_bound: 84.82
    params_vars_margin_of_error_part4: 0.909
    params_vars_selected_option1: If we considered many random samples of 1639 Americans,
