...
myst:
  substitutions:
    ...
    params_vars_sample_size: 1255
    params_vars_proportion: 44.0
    params_vars_margin_of_error: 2.75
    params_vars_lower_bound: 41.25
    params_vars_upper_bound: 46.75
    params_vars_margin_of_error_part4: 1.373
