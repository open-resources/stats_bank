...
myst:
  substitutions:
    ...
    params_vars_sample_size: 1145
    params_vars_proportion: 35.0
    params_vars_margin_of_error: 2.76
    params_vars_lower_bound: 32.24
    params_vars_upper_bound: 37.76
    params_vars_margin_of_error_part4: 1.381
