...
myst:
  substitutions:
    ...
    params_vars_sample_size: 1737
    params_vars_proportion: 89.0
    params_vars_margin_of_error: 1.47
    params_vars_lower_bound: 87.53
    params_vars_upper_bound: 90.47
    params_vars_margin_of_error_part4: 0.736
    params_vars_selected_option1: If we considered many random samples of 1737 Americans,
    ...
    params_vars_selected_option2: In order to decrease the margin of error to 0.014714297335682584%,
