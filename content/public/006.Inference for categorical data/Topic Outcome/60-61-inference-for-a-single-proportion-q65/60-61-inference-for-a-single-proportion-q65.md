...
myst:
  substitutions:
    ...
    params_vars_sample_size: 1086
    params_vars_proportion: 59.0
    params_vars_margin_of_error: 2.93
    params_vars_lower_bound: 56.07
    params_vars_upper_bound: 61.93
    params_vars_margin_of_error_part4: 1.463
