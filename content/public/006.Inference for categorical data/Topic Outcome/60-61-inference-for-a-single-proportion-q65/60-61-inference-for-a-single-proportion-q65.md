...
myst:
  substitutions:
    ...
    params_vars_sample_size: 1843
    params_vars_proportion: 39.0
    params_vars_margin_of_error: 2.23
    params_vars_lower_bound: 36.77
    params_vars_upper_bound: 41.23
    params_vars_margin_of_error_part4: 1.113
    params_vars_selected_option1: If we considered many random samples of 1843 Americans,
    ...
    params_vars_selected_option2: In order to decrease the margin of error to 0.022268073413893256%,
