  ...
  substitutions:
    params:
      vars:
        ...
        lower_bound: 35.42
        upper_bound: 40.58
        margin_of_error_part4: 1.288
        selected_option1: If we considered many random samples of 1364 Americans,
        ...
        selected_option2: In order to decrease the margin of error to 0.02575897329849584%,
