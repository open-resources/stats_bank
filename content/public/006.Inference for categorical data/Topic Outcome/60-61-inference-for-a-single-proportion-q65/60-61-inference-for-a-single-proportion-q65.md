...
myst:
  substitutions:
    ...
    params_vars_sample_size: 1228
    params_vars_proportion: 25.0
    params_vars_margin_of_error: 2.42
    params_vars_lower_bound: 22.58
    params_vars_upper_bound: 27.42
    params_vars_margin_of_error_part4: 1.211
