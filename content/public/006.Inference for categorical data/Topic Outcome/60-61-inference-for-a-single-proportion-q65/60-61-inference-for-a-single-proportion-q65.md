...
myst:
  substitutions:
    ...
    params_vars_sample_size: 1036
    params_vars_proportion: 41.0
    params_vars_margin_of_error: 2.99
    params_vars_lower_bound: 38.01
    params_vars_upper_bound: 43.99
    params_vars_margin_of_error_part4: 1.497
    params_vars_selected_option1: If we considered many random samples of 1036 Americans,
