  ...
  substitutions:
    params:
      vars:
        ...
        sample_size: 3624
        sample_proportion: 19.0
        Z: -23.564598926793668
        p_value: 8.894876455326533e-123
        lower_bound: 0.17722734190929756
        upper_bound: 0.20277265809070244
      part1:
        ans1:
          value: '$H_0: p = 0.19$, $H_A: p ≠ 0.38$'
