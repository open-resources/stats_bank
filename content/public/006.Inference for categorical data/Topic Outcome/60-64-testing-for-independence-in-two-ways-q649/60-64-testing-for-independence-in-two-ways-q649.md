  ...
  substitutions:
    params:
      vars:
        ...
        sample_size: 4719
        sample_proportion: 20.0
        Z: -25.474745308969744
        p_value: 3.755907960611229e-143
        lower_bound: 0.1885872297651647
        upper_bound: 0.21141277023483532
      part1:
        ans1:
          value: '$H_0: p = 0.2$, $H_A: p ≠ 0.38$'
