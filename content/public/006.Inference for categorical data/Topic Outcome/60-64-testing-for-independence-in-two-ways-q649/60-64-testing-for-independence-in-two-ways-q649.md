  ...
  substitutions:
    params:
      vars:
        ...
        sample_size: 4214
        sample_proportion: 30.0
        Z: -10.699158210703171
        p_value: 1.0270699770571599e-26
        lower_bound: 0.28616374832315067
        upper_bound: 0.3138362516768493
      part1:
        ans1:
          value: '$H_0: p = 0.3$, $H_A: p ≠ 0.38$'
