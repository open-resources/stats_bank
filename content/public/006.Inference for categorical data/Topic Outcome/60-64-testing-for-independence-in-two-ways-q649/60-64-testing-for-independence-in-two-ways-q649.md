  ...
  substitutions:
    params:
      vars:
        ...
        sample_size: 1126
        sample_proportion: 42.0
        Z: 2.7652954784600943
        p_value: 0.005687125526357528
        lower_bound: 0.39117126951115294
        upper_bound: 0.448828730488847
      part1:
        ans1:
          value: '$H_0: p = 0.42$, $H_A: p ≠ 0.38$'
