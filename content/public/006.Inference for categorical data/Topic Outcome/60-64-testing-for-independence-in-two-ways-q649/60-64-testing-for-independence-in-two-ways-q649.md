  ...
  substitutions:
    params:
      vars:
        ...
        sample_size: 1387
        sample_proportion: 15.0
        Z: -17.647306291749988
        p_value: 1.0672674417183745e-69
        lower_bound: 0.1312080030533482
        upper_bound: 0.16879199694665178
      part1:
        ans1:
          value: '$H_0: p = 0.15$, $H_A: p ≠ 0.38$'
