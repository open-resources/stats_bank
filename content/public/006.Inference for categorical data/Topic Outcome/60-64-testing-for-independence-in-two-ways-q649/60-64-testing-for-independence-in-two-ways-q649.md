  ...
  substitutions:
    params:
      vars:
        ...
        sample_size: 1145
        sample_proportion: 2.0
        Z: -25.096756735517953
        p_value: 5.395780153265098e-139
        lower_bound: 0.011890737410960769
        upper_bound: 0.02810926258903923
      part1:
        ans1:
          value: '$H_0: p = 0.02$, $H_A: p ≠ 0.38$'
