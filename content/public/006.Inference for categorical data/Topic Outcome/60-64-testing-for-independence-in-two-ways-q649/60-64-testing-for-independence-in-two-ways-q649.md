  ...
  substitutions:
    params:
      vars:
        ...
        sample_size: 1829
        sample_proportion: 35.0
        Z: -2.6432635330710346
        p_value: 0.008211109818296097
        lower_bound: 0.3281405153437495
        upper_bound: 0.37185948465625046
      part1:
        ans1:
          value: '$H_0: p = 0.35$, $H_A: p ≠ 0.38$'
