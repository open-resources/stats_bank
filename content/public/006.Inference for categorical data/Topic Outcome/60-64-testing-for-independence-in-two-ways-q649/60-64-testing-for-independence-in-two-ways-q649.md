  ...
  substitutions:
    params:
      vars:
        ...
        sample_size: 4893
        sample_proportion: 21.0
        Z: -24.499029813436707
        p_value: 1.5127319950995962e-132
        lower_bound: 0.19858721445834793
        upper_bound: 0.22141278554165206
      part1:
        ans1:
          value: '$H_0: p = 0.21$, $H_A: p ≠ 0.38$'
