  ...
  substitutions:
    params:
      vars:
        ...
        sample_size: 3131
        sample_proportion: 11.0
        Z: -31.125594477518778
        p_value: 1.0853174951985901e-212
        lower_bound: 0.09904011787067371
        upper_bound: 0.12095988212932629
      part1:
        ans1:
          value: '$H_0: p = 0.11$, $H_A: p ≠ 0.38$'
