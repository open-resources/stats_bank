  ...
  substitutions:
    params:
      vars:
        ...
        sample_size: 1439
        sample_proportion: 23.0
        Z: -11.722871728461822
        p_value: 9.731618817980757e-32
        lower_bound: 0.2082562245213962
        upper_bound: 0.2517437754786038
      part1:
        ans1:
          value: '$H_0: p = 0.23$, $H_A: p ≠ 0.38$'
