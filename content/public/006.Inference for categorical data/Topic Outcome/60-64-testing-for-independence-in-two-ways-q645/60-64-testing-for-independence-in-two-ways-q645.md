...
myst:
  substitutions:
    ...
    params_vars_ci_low_part4: 0.4488859731249242
    params_vars_ci_high_part4: 0.5369726127336617
    params_vars_ci_low_part4_percent: 45
    params_vars_ci_high_part4_percent: 54
    params_vars_ci_low_part8: 0.435043786900694
    params_vars_ci_high_part8: 0.5508147989578919
    ...
    params_description_num1: 244
    params_description_num2: 495
    params_description_num3: 4774
    params_part3_ans1_value: This is not a random sample, so the observations are
      not independent.
    params_part3_ans1_feedback: Incorrect.
    params_part3_ans2_value: 'The success-failure condition is not satisfied: 244
      successes, 251 failures, both below 10.'
    params_part3_ans2_feedback: Incorrect.
    params_part3_ans3_value: 'The success-failure condition is satisfied: 244 successes,
      251 failures, both well above 10.'
