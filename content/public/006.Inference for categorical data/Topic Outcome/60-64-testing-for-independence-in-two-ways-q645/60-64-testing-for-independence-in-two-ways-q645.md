...
myst:
  substitutions:
    ...
    params_vars_ci_low_part4: 0.8751693353464408
    params_vars_ci_high_part4: 0.9343544741773687
    params_vars_ci_low_part4_percent: 88
    params_vars_ci_high_part4_percent: 93
    params_vars_ci_low_part8: 0.8658688135301521
    params_vars_ci_high_part8: 0.9436549959936574
    ...
    params_description_num1: 342
    params_description_num2: 378
    params_description_num3: 4319
    params_part3_ans1_value: This is not a random sample, so the observations are
      not independent.
    params_part3_ans1_feedback: Incorrect.
    params_part3_ans2_value: 'The success-failure condition is not satisfied: 342
      successes, 36 failures, both below 10.'
    params_part3_ans2_feedback: Incorrect.
    params_part3_ans3_value: 'The success-failure condition is satisfied: 342 successes,
      36 failures, both well above 10.'
