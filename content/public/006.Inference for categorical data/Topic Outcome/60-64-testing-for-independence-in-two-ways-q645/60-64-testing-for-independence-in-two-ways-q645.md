...
myst:
  substitutions:
    ...
    params_vars_ci_low_part4: 0.5251977382860112
    params_vars_ci_high_part4: 0.6135186178216493
    params_vars_ci_low_part4_percent: 53
    params_vars_ci_high_part4_percent: 61
    params_vars_ci_low_part8: 0.511318742930411
    params_vars_ci_high_part8: 0.6273976131772495
    ...
    params_description_num1: 275
    params_description_num2: 483
    params_description_num3: 4506
    params_part3_ans1_value: This is not a random sample, so the observations are
      not independent.
    params_part3_ans1_feedback: Incorrect.
    params_part3_ans2_value: 'The success-failure condition is not satisfied: 275
      successes, 208 failures, both below 10.'
    params_part3_ans2_feedback: Incorrect.
    params_part3_ans3_value: 'The success-failure condition is satisfied: 275 successes,
      208 failures, both well above 10.'
