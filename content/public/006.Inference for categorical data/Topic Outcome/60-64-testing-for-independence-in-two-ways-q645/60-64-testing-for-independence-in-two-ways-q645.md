...
myst:
  substitutions:
    ...
    params_vars_ci_low_part4: 0.4820420985089822
    params_vars_ci_high_part4: 0.5776237726127361
    params_vars_ci_low_part4_percent: 48
    params_vars_ci_high_part4_percent: 58
    params_vars_ci_low_part8: 0.4670221211498209
    params_vars_ci_high_part8: 0.5926437499718975
    ...
    params_description_num1: 222
    params_description_num2: 419
    params_description_num3: 4544
    params_part3_ans1_value: This is not a random sample, so the observations are
      not independent.
    params_part3_ans1_feedback: Incorrect.
    params_part3_ans2_value: 'The success-failure condition is not satisfied: 222
      successes, 197 failures, both below 10.'
    params_part3_ans2_feedback: Incorrect.
    params_part3_ans3_value: 'The success-failure condition is satisfied: 222 successes,
      197 failures, both well above 10.'
