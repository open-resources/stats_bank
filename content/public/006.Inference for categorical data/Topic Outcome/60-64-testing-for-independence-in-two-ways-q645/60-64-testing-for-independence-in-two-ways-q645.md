...
myst:
  substitutions:
    ...
    params_vars_ci_low_part4: 0.7070123895863991
    params_vars_ci_high_part4: 0.8006799181059086
    params_vars_ci_low_part4_percent: 71
    params_vars_ci_high_part4_percent: 80
    params_vars_ci_low_part8: 0.6922932065333334
    params_vars_ci_high_part8: 0.8153991011589743
    ...
    params_description_num1: 245
    params_description_num2: 325
    params_description_num3: 4537
    params_part3_ans1_value: This is not a random sample, so the observations are
      not independent.
    params_part3_ans1_feedback: Incorrect.
    params_part3_ans2_value: 'The success-failure condition is not satisfied: 245
      successes, 80 failures, both below 10.'
    params_part3_ans2_feedback: Incorrect.
    params_part3_ans3_value: 'The success-failure condition is satisfied: 245 successes,
