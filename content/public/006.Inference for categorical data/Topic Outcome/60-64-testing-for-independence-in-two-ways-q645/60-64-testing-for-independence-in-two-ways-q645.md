...
myst:
  substitutions:
    ...
    params_vars_ci_low_part4: 0.9629602781842196
    params_vars_ci_high_part4: 0.9930836778597364
    params_vars_ci_low_part4_percent: 96
    params_vars_ci_high_part4_percent: 99
    params_vars_ci_low_part8: 0.9582266010923527
    params_vars_ci_high_part8: 0.9978173549516033
    ...
    params_description_num1: 356
    params_description_num2: 364
    params_description_num3: 4310
    params_part3_ans1_value: This is not a random sample, so the observations are
      not independent.
    params_part3_ans1_feedback: Incorrect.
    params_part3_ans2_value: 'The success-failure condition is not satisfied: 356
      successes, 8 failures, both below 10.'
    params_part3_ans2_feedback: Incorrect.
    params_part3_ans3_value: 'The success-failure condition is satisfied: 356 successes,
      8 failures, both well above 10.'
