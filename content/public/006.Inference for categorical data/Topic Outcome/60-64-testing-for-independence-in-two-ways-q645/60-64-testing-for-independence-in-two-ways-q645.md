...
myst:
  substitutions:
    ...
    params_vars_ci_low_part4: 0.6123187693983104
    params_vars_ci_high_part4: 0.7131250175839382
    params_vars_ci_low_part4_percent: 61
    params_vars_ci_high_part4_percent: 71
    params_vars_ci_low_part8: 0.5964777875405689
    params_vars_ci_high_part8: 0.7289659994416797
    ...
    params_description_num2: 338
    params_description_num3: 4678
    params_part3_ans1_value: This is not a random sample, so the observations are
      not independent.
    params_part3_ans1_feedback: Incorrect.
    params_part3_ans2_value: 'The success-failure condition is not satisfied: 224
      successes, 114 failures, both below 10.'
    params_part3_ans2_feedback: Incorrect.
    params_part3_ans3_value: 'The success-failure condition is satisfied: 224 successes,
      114 failures, both well above 10.'
