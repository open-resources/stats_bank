...
myst:
  substitutions:
    ...
    params_vars_ci_low_part4: 0.5480271029907293
    params_vars_ci_high_part4: 0.6348997262775633
    params_vars_ci_low_part4_percent: 55
    params_vars_ci_high_part4_percent: 63
    params_vars_ci_low_part8: 0.5343756907599412
    params_vars_ci_high_part8: 0.6485511385083514
    ...
    params_description_num1: 291
    params_description_num2: 492
    params_description_num3: 4355
    params_part3_ans1_value: This is not a random sample, so the observations are
      not independent.
    params_part3_ans1_feedback: Incorrect.
    params_part3_ans2_value: 'The success-failure condition is not satisfied: 291
      successes, 201 failures, both below 10.'
    params_part3_ans2_feedback: Incorrect.
    params_part3_ans3_value: 'The success-failure condition is satisfied: 291 successes,
      201 failures, both well above 10.'
