...
myst:
  substitutions:
    ...
    params_vars_ci_low_part4: 0.637595789693876
    params_vars_ci_high_part4: 0.7300134648048386
    params_vars_ci_low_part4_percent: 64
    params_vars_ci_high_part4_percent: 73
    params_vars_ci_low_part8: 0.6230730121764391
    params_vars_ci_high_part8: 0.7445362423222756
    ...
    params_description_num1: 266
    params_description_num2: 389
    params_description_num3: 4578
    params_part3_ans1_value: This is not a random sample, so the observations are
      not independent.
    params_part3_ans1_feedback: Incorrect.
    params_part3_ans2_value: 'The success-failure condition is not satisfied: 266
      successes, 123 failures, both below 10.'
    params_part3_ans2_feedback: Incorrect.
    params_part3_ans3_value: 'The success-failure condition is satisfied: 266 successes,
      123 failures, both well above 10.'
