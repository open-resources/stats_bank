...
myst:
  substitutions:
    ...
    params_vars_ci_low_part4: 0.5608113026114883
    params_vars_ci_high_part4: 0.6531421857606048
    params_vars_ci_low_part4_percent: 56
    params_vars_ci_high_part4_percent: 65
    params_vars_ci_low_part8: 0.5463021638309128
    params_vars_ci_high_part8: 0.6676513245411803
    ...
    params_description_num1: 261
    params_description_num2: 430
    params_description_num3: 4306
    params_part3_ans1_value: This is not a random sample, so the observations are
      not independent.
    params_part3_ans1_feedback: Incorrect.
    params_part3_ans2_value: 'The success-failure condition is not satisfied: 261
      successes, 169 failures, both below 10.'
    params_part3_ans2_feedback: Incorrect.
    params_part3_ans3_value: 'The success-failure condition is satisfied: 261 successes,
      169 failures, both well above 10.'
