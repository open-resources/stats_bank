...
myst:
  substitutions:
    ...
    params_vars_ci_low_part4: 0.9846851077868651
    params_vars_ci_high_part4: 1.0024531558787297
    params_vars_ci_low_part4_percent: 98
    params_vars_ci_high_part4_percent: 100
    params_vars_ci_low_part8: 0.9818929859438578
    params_vars_ci_high_part8: 1.0052452777217369
    ...
    params_description_num1: 309
    params_description_num2: 311
    params_description_num3: 4765
    params_part3_ans1_value: This is not a random sample, so the observations are
      not independent.
    params_part3_ans1_feedback: Incorrect.
    params_part3_ans2_value: 'The success-failure condition is not satisfied: 309
      successes, 2 failures, both below 10.'
    params_part3_ans2_feedback: Incorrect.
    params_part3_ans3_value: 'The success-failure condition is satisfied: 309 successes,
      2 failures, both well above 10.'
