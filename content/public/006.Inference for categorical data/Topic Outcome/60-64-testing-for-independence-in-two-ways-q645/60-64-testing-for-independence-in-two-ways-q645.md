...
myst:
  substitutions:
    ...
    params_vars_ci_low_part4: 0.900464403538277
    params_vars_ci_high_part4: 0.9550269259414919
    params_vars_ci_low_part4_percent: 90
    params_vars_ci_high_part4_percent: 96
    params_vars_ci_low_part8: 0.8918902928749146
    params_vars_ci_high_part8: 0.9636010366048542
    ...
    params_description_num1: 321
    params_description_num2: 346
    params_description_num3: 4251
    params_part3_ans1_value: This is not a random sample, so the observations are
      not independent.
    params_part3_ans1_feedback: Incorrect.
    params_part3_ans2_value: 'The success-failure condition is not satisfied: 321
      successes, 25 failures, both below 10.'
    params_part3_ans2_feedback: Incorrect.
    params_part3_ans3_value: 'The success-failure condition is satisfied: 321 successes,
      25 failures, both well above 10.'
