...
myst:
  substitutions:
    ...
    params_vars_ci_low_part4: 0.7652945534024324
    params_vars_ci_high_part4: 0.8505591051341531
    params_vars_ci_low_part4_percent: 77
    params_vars_ci_high_part4_percent: 85
    params_vars_ci_low_part8: 0.7518958381303048
    params_vars_ci_high_part8: 0.8639578204062807
    ...
    params_description_num1: 265
    params_description_num2: 328
    params_description_num3: 4339
    params_part3_ans1_value: This is not a random sample, so the observations are
      not independent.
    params_part3_ans1_feedback: Incorrect.
    params_part3_ans2_value: 'The success-failure condition is not satisfied: 265
      successes, 63 failures, both below 10.'
    params_part3_ans2_feedback: Incorrect.
    params_part3_ans3_value: 'The success-failure condition is satisfied: 265 successes,
      63 failures, both well above 10.'
