...
myst:
  substitutions:
    ...
    params_vars_ci_low_part4: 0.7948346222420782
    params_vars_ci_high_part4: 0.8784987110912551
    params_vars_ci_low_part4_percent: 79
    params_vars_ci_high_part4_percent: 88
    params_vars_ci_low_part8: 0.7816874082800647
    params_vars_ci_high_part8: 0.8916459250532687
    ...
    params_description_num1: 251
    params_description_num2: 300
    params_description_num3: 4570
    params_part3_ans1_value: This is not a random sample, so the observations are
      not independent.
    params_part3_ans1_feedback: Incorrect.
    params_part3_ans2_value: 'The success-failure condition is not satisfied: 251
      successes, 49 failures, both below 10.'
    params_part3_ans2_feedback: Incorrect.
    params_part3_ans3_value: 'The success-failure condition is satisfied: 251 successes,
      49 failures, both well above 10.'
