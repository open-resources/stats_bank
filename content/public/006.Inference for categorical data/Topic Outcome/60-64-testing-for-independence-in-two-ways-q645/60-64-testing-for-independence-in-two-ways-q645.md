...
myst:
  substitutions:
    ...
    params_vars_ci_low_part4: 0.9474086108556274
    params_vars_ci_high_part4: 0.9823337779031547
    params_vars_ci_low_part4_percent: 95
    params_vars_ci_high_part4_percent: 98
    params_vars_ci_low_part8: 0.9419203703195875
    params_vars_ci_high_part8: 0.9878220184391946
    ...
    params_description_num1: 412
    params_description_num2: 427
    params_description_num3: 4257
    params_part3_ans1_value: This is not a random sample, so the observations are
      not independent.
    params_part3_ans1_feedback: Incorrect.
    params_part3_ans2_value: 'The success-failure condition is not satisfied: 412
      successes, 15 failures, both below 10.'
    params_part3_ans2_feedback: Incorrect.
    params_part3_ans3_value: 'The success-failure condition is satisfied: 412 successes,
      15 failures, both well above 10.'
