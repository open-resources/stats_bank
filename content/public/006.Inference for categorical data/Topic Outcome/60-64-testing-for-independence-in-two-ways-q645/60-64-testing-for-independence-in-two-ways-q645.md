...
myst:
  substitutions:
    ...
    params_vars_ci_low_part4: 0.6924509281949498
    params_vars_ci_high_part4: 0.7865909879727149
    params_vars_ci_low_part4_percent: 69
    params_vars_ci_high_part4_percent: 79
    params_vars_ci_low_part8: 0.6776574902298724
    params_vars_ci_high_part8: 0.8013844259377922
    ...
    params_description_num1: 247
    params_description_num2: 334
    params_description_num3: 4212
    params_part3_ans1_value: This is not a random sample, so the observations are
      not independent.
    params_part3_ans1_feedback: Incorrect.
    params_part3_ans2_value: 'The success-failure condition is not satisfied: 247
      successes, 87 failures, both below 10.'
    params_part3_ans2_feedback: Incorrect.
    params_part3_ans3_value: 'The success-failure condition is satisfied: 247 successes,
      87 failures, both well above 10.'
