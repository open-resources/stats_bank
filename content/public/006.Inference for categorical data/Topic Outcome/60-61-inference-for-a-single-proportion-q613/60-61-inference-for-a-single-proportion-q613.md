...
myst:
  substitutions:
    ...
    params_vars_sample: 90
    params_vars_p_value: 0.011412036386001745
    ...
    params_part2_ans1_value: Since this is a random sample, independence is satisfied.
      ...
      expect 45 successes and 45 failures).
    params_part2_ans1_feedback: Correct!
    params_part2_ans2_value: Since this is a random sample, independence is satisfied.
      The success-failure condition is not satisfied, as our expectation of 45 successes
      and 45 failures, using $p_0 = 0.5$, is not met.
    ...
    params_part2_ans3_value: Given this is not a random sample, independence is not
      ...
      = 0.5$, we expect 45 successes and 45 failures).
