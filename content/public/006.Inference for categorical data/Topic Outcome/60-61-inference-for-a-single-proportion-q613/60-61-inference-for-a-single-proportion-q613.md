...
myst:
  substitutions:
    ...
    params_vars_sample: 74
    params_vars_p_value: 1.04801950984168e-06
    params_part1_ans1_value: '$H_0: p = 0.78$, $H_A: p ≠ 0.5$'
    params_part1_ans1_feedback: Try again please!
    params_part1_ans2_value: '$H_0: p = 0.78$, $H_A: p = 0.5$'
    ...
    params_part2_ans1_value: Since this is a random sample, independence is satisfied.
      ...
      expect 37 successes and 37 failures).
    params_part2_ans1_feedback: Correct!
    params_part2_ans2_value: Since this is a random sample, independence is satisfied.
      The success-failure condition is not satisfied, as our expectation of 37 successes
      and 37 failures, using $p_0 = 0.5$, is not met.
    ...
    params_part2_ans3_value: Given this is not a random sample, independence is not
      ...
      = 0.5$, we expect 37 successes and 37 failures).
