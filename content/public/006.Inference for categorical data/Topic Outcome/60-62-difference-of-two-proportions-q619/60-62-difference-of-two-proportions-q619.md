  ...
  substitutions:
    params:
      ...
      part5:
        ans1:
          value: 'False'
          feedback: 'It is simply the negated and reordered values: (0.13, 0.23).'
        ans2:
          value: 'True'
          feedback: Incorrect!
      lower_bound_percent_abs: 23.0
      upper_bound_percent_abs: 13.0
      lower_bound_percent_abs_p2: 13.0
      upper_bound_percent_abs_p2: 23.0
      lower_bound: -0.23
      upper_bound: -0.13
      male_sample_size: 1607
      female_sample_size: 3706
---
# {{ params.vars.title }}
