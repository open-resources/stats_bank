...
myst:
  substitutions:
    ...
    params_part5_ans1_feedback: 'It is simply the negated and reordered values: (0.18,
      0.26).'
    params_part5_ans2_value: 'True'
    params_part5_ans2_feedback: Incorrect!
    params_lower_bound_percent_abs: 26.0
    params_upper_bound_percent_abs: 18.0
    params_lower_bound_percent_abs_p2: 18.0
    params_upper_bound_percent_abs_p2: 26.0
    params_lower_bound: -0.26
    params_upper_bound: -0.18
    params_male_sample_size: 1732
    params_female_sample_size: 3678
---
# {{ params_vars_title }}
