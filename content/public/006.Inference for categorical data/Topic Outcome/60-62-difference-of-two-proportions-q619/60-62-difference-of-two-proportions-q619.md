  ...
  substitutions:
    params:
      ...
      part5:
        ans1:
          value: 'False'
          feedback: 'It is simply the negated and reordered values: (0.26, 0.32).'
        ans2:
          value: 'True'
          feedback: Incorrect!
      lower_bound_percent_abs: 32.0
      upper_bound_percent_abs: 26.0
      lower_bound_percent_abs_p2: 26.0
      upper_bound_percent_abs_p2: 32.0
      lower_bound: -0.32
      upper_bound: -0.26
      male_sample_size: 1674
      female_sample_size: 3025
---
# {{ params.vars.title }}
