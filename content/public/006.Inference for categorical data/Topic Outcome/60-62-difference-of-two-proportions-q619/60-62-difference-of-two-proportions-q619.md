...
myst:
  substitutions:
    ...
    params_lower_bound_percent_abs: 0.0
    params_upper_bound_percent_abs: 8.0
    params_lower_bound_percent_abs_p2: 0.0
    params_upper_bound_percent_abs_p2: 8.0
    params_lower_bound: 0.0
    params_upper_bound: 0.08
    params_male_sample_size: 1672
    params_female_sample_size: 3127
---
# {{ params_vars_title }}
