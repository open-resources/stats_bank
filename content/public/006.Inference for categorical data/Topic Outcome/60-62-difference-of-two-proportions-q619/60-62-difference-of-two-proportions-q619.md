  ...
  substitutions:
    params:
      ...
      part5:
        ans1:
          value: 'False'
          feedback: 'It is simply the negated and reordered values: (0.1, 0.14).'
        ans2:
          value: 'True'
          feedback: Incorrect!
      lower_bound_percent_abs: 14.0
      upper_bound_percent_abs: 10.0
      lower_bound_percent_abs_p2: 10.0
      upper_bound_percent_abs_p2: 14.0
      lower_bound: -0.14
      upper_bound: -0.1
      male_sample_size: 1673
      female_sample_size: 3550
---
# {{ params.vars.title }}
