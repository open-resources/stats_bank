...
myst:
  substitutions:
    ...
    params_part5_ans1_feedback: 'It is simply the negated and reordered values: (0.21,
      0.25).'
    params_part5_ans2_value: 'True'
    params_part5_ans2_feedback: Incorrect!
    params_lower_bound_percent_abs: 25.0
    params_upper_bound_percent_abs: 21.0
    params_lower_bound_percent_abs_p2: 21.0
    params_upper_bound_percent_abs_p2: 25.0
    params_lower_bound: -0.25
    params_upper_bound: -0.21
    params_male_sample_size: 1764
    params_female_sample_size: 3630
---
# {{ params_vars_title }}
