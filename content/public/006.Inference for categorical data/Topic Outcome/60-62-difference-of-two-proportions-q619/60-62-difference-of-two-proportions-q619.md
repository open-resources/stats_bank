  ...
  substitutions:
    params:
      ...
      part5:
        ans1:
          value: 'False'
          feedback: 'It is simply the negated and reordered values: (0.08, 0.18).'
        ans2:
          value: 'True'
          feedback: Incorrect!
      lower_bound_percent_abs: 18.0
      upper_bound_percent_abs: 8.0
      lower_bound_percent_abs_p2: 8.0
      upper_bound_percent_abs_p2: 18.0
      lower_bound: -0.18
      upper_bound: -0.08
      male_sample_size: 1742
      female_sample_size: 3420
---
# {{ params.vars.title }}
