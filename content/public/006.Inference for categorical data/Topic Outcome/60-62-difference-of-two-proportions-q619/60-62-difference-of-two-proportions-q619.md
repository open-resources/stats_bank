...
myst:
  substitutions:
    ...
    params_part5_ans1_feedback: 'It is simply the negated and reordered values: (0.1,
      0.22).'
    params_part5_ans2_value: 'True'
    params_part5_ans2_feedback: Incorrect!
    params_lower_bound_percent_abs: 22.0
    params_upper_bound_percent_abs: 10.0
    params_lower_bound_percent_abs_p2: 10.0
    params_upper_bound_percent_abs_p2: 22.0
    params_lower_bound: -0.22
    params_upper_bound: -0.1
    params_male_sample_size: 1982
    params_female_sample_size: 3003
---
# {{ params_vars_title }}
