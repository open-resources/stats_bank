  ...
  substitutions:
    params:
      ...
      part5:
        ans1:
          value: 'False'
          feedback: 'It is simply the negated and reordered values: (0.14, 0.24).'
        ans2:
          value: 'True'
          feedback: Incorrect!
      lower_bound_percent_abs: 24.0
      upper_bound_percent_abs: 14.0
      lower_bound_percent_abs_p2: 14.0
      upper_bound_percent_abs_p2: 24.0
      lower_bound: -0.24
      upper_bound: -0.14
      male_sample_size: 1689
      female_sample_size: 3150
---
# {{ params.vars.title }}
