...
myst:
  substitutions:
    ...
    params_lower_bound_percent_abs: 2.0
    params_upper_bound_percent_abs: 10.0
    params_lower_bound_percent_abs_p2: 2.0
    params_upper_bound_percent_abs_p2: 10.0
    params_lower_bound: 0.02
    params_upper_bound: 0.1
    params_male_sample_size: 1948
    params_female_sample_size: 3545
---
# {{ params_vars_title }}
