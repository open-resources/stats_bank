...
myst:
  substitutions:
    ...
    params_part5_ans1_feedback: 'It is simply the negated and reordered values: (0.23,
      0.27).'
    params_part5_ans2_value: 'True'
    params_part5_ans2_feedback: Incorrect!
    params_lower_bound_percent_abs: 27.0
    params_upper_bound_percent_abs: 23.0
    params_lower_bound_percent_abs_p2: 23.0
    params_upper_bound_percent_abs_p2: 27.0
    params_lower_bound: -0.27
    params_upper_bound: -0.23
    params_male_sample_size: 1753
    params_female_sample_size: 3752
---
# {{ params_vars_title }}
