  ...
  substitutions:
    params:
      ...
      part5:
        ans1:
          value: 'False'
          feedback: 'It is simply the negated and reordered values: (0.02, 0.12).'
        ans2:
          value: 'True'
          feedback: Incorrect!
      lower_bound_percent_abs: 12.0
      upper_bound_percent_abs: 2.0
      lower_bound_percent_abs_p2: 2.0
      upper_bound_percent_abs_p2: 12.0
      lower_bound: -0.12
      upper_bound: -0.02
      male_sample_size: 1847
      female_sample_size: 3702
---
# {{ params.vars.title }}
