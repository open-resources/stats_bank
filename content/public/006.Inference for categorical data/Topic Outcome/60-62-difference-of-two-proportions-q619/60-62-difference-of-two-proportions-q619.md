  ...
  substitutions:
    params:
      ...
      part5:
        ans1:
          value: 'False'
          feedback: 'It is simply the negated and reordered values: (0.12, 0.2).'
        ans2:
          value: 'True'
          feedback: Incorrect!
      lower_bound_percent_abs: 20.0
      upper_bound_percent_abs: 12.0
      lower_bound_percent_abs_p2: 12.0
      upper_bound_percent_abs_p2: 20.0
      lower_bound: -0.2
      upper_bound: -0.12
      male_sample_size: 1882
      female_sample_size: 3653
---
# {{ params.vars.title }}
