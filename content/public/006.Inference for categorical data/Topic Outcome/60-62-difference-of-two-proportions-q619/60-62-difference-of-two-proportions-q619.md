  ...
  substitutions:
    params:
      ...
      part5:
        ans1:
          value: 'False'
          feedback: 'It is simply the negated and reordered values: (-0.0, 0.04).'
        ans2:
          value: 'True'
          feedback: Incorrect!
      lower_bound_percent_abs: 4.0
      upper_bound_percent_abs: 0.0
      lower_bound_percent_abs_p2: 0.0
      upper_bound_percent_abs_p2: 4.0
      lower_bound: -0.04
      upper_bound: 0.0
      male_sample_size: 1707
      female_sample_size: 3071
---
# {{ params.vars.title }}
