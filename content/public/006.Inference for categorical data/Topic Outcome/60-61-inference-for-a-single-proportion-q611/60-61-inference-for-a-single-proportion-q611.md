...
myst:
  substitutions:
    ...
    params_vars_sample_size: 506
    params_vars_sample_proportion: 65
    params_part1_ans1_value: '$H_0: p = 0.65$, $H_A: p ≠ 0.5$'
    params_part1_ans1_feedback: Try again please!
    params_part1_ans2_value: '$H_0: p = 0.65$, $H_A: p = 0.5$'
    ...
    params_part7_ans1_value: Yes. Since 65% of Independents support the plan, the
