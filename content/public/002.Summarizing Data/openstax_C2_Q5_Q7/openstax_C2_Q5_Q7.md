...
myst:
  substitutions:
    params:
      ...
      df: null
      autograding:
        std_plot: std__m67cxye_plot.png
        ref_plot: ref_gphfihj__plot.png
        csv: |
          Number of times in store,Frequency
          1,6
          2,9
      ...
      - label: Your Line Graph
        filename: std__m67cxye_plot.png
        part: Check graph is similar to expected graph
      - label: Expected Line Graph
        filename: ref_gphfihj__plot.png
        part: Check graph is similar to expected graph
      _autograder_files:
      - path: /grade/tests/data.csv
        contents: TnVtYmVyIG9mIHRpbWVzIGluIHN0b3JlLEZyZXF1ZW5jeQoxLDYKMiw5CjMsMTEKNCw2CjUsMgo=
