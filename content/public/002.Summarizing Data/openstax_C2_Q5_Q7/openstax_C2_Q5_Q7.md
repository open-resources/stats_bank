...
myst:
  substitutions:
    params:
      ...
      df: null
      autograding:
        std_plot: std_dik827y9_plot.png
        ref_plot: ref_ufeeei6p_plot.png
        csv: |
          Number of times in store,Frequency
          1,5
          2,9
      ...
      - label: Your Line Graph
        filename: std_dik827y9_plot.png
        part: Check graph is similar to expected graph
      - label: Expected Line Graph
        filename: ref_ufeeei6p_plot.png
        part: Check graph is similar to expected graph
      _autograder_files:
      - path: /grade/tests/data.csv
        contents: TnVtYmVyIG9mIHRpbWVzIGluIHN0b3JlLEZyZXF1ZW5jeQoxLDUKMiw5CjMsMTMKNCwyCjUsNAo=
