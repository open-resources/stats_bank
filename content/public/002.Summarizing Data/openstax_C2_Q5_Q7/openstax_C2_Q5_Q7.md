...
myst:
  substitutions:
    params:
      ...
      df: null
      autograding:
        std_plot: std_sy6fw0pf_plot.png
        ref_plot: ref_afpne_jd_plot.png
        csv: |
          Number of times in store,Frequency
          1,2
          2,16
      ...
      - label: Your Line Graph
        filename: std_sy6fw0pf_plot.png
        part: Check graph is similar to expected graph
      - label: Expected Line Graph
        filename: ref_afpne_jd_plot.png
        part: Check graph is similar to expected graph
      _autograder_files:
      - path: /grade/tests/data.csv
        contents: TnVtYmVyIG9mIHRpbWVzIGluIHN0b3JlLEZyZXF1ZW5jeQoxLDIKMiwxNgozLDE2CjQsMwo1LDUK
