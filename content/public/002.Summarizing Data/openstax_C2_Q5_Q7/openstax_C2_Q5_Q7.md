...
myst:
  substitutions:
    params:
      vars:
        title: Line Graphs
        description: In a survey, 43 people were asked how many times they visited
      ...
      df: null
      autograding:
        std_plot: std_dwfbioc2_plot.png
        ref_plot: ref_1cjl79kl_plot.png
        csv: |
          Number of times in store,Frequency
          1,2
          2,9
      ...
      - label: Your Line Graph
        filename: std_dwfbioc2_plot.png
        part: Check graph is similar to expected graph
      - label: Expected Line Graph
        filename: ref_1cjl79kl_plot.png
        part: Check graph is similar to expected graph
      _autograder_files:
      - path: /grade/tests/data.csv
        contents: TnVtYmVyIG9mIHRpbWVzIGluIHN0b3JlLEZyZXF1ZW5jeQoxLDIKMiw5CjMsMjAKNCw5CjUsMwo=
