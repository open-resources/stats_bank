...
myst:
  substitutions:
    params:
      ...
      df: null
      autograding:
        std_plot: std_6rxisc0r_plot.png
        ref_plot: ref_h1e7l0hw_plot.png
        csv: |
          Number of TV Shows,Frequency
          0,11
          1,15
      ...
      - label: Your Line Graph
        filename: std_6rxisc0r_plot.png
        part: Check graph is similar to expected graph
      - label: Expected Line Graph
        filename: ref_h1e7l0hw_plot.png
        part: Check graph is similar to expected graph
      _autograder_files:
      - path: /grade/tests/data.csv
        contents: TnVtYmVyIG9mIFRWIFNob3dzLEZyZXF1ZW5jeQowLDExCjEsMTUKMiwzMwozLDUKNCwzCg==
