...
myst:
  substitutions:
    params:
      ...
      df: null
      autograding:
        std_plot: std_o15x0wxn_plot.png
        ref_plot: ref_4z5s9ux2_plot.png
        csv: |
          Number of times in store,Frequency
          1,4
          2,13
      ...
      - label: Your Line Graph
        filename: std_o15x0wxn_plot.png
        part: Check graph is similar to expected graph
      - label: Expected Line Graph
        filename: ref_4z5s9ux2_plot.png
        part: Check graph is similar to expected graph
      _autograder_files:
      - path: /grade/tests/data.csv
        contents: TnVtYmVyIG9mIHRpbWVzIGluIHN0b3JlLEZyZXF1ZW5jeQoxLDQKMiwxMwozLDExCjQsNgo1LDIK
