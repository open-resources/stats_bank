...
myst:
  substitutions:
    params:
      ...
      df: null
      autograding:
        std_plot: std_t7n6nxfx_plot.png
        ref_plot: ref_rre2bsi5_plot.png
        csv: |
          Number of times in store,Frequency
          1,3
          2,4
      ...
      - label: Your Line Graph
        filename: std_t7n6nxfx_plot.png
        part: Check graph is similar to expected graph
      - label: Expected Line Graph
        filename: ref_rre2bsi5_plot.png
        part: Check graph is similar to expected graph
      _autograder_files:
      - path: /grade/tests/data.csv
        contents: TnVtYmVyIG9mIHRpbWVzIGluIHN0b3JlLEZyZXF1ZW5jeQoxLDMKMiw0CjMsMTQKNCw2CjUsNAo=
