...
myst:
  substitutions:
    params:
      ...
      df: null
      autograding:
        std_plot: std_ljmk6dpu_plot.png
        ref_plot: ref_2b4hhaz8_plot.png
        csv: |
          Number of times in store,Frequency
          1,3
          2,11
      ...
      - label: Your Line Graph
        filename: std_ljmk6dpu_plot.png
        part: Check graph is similar to expected graph
      - label: Expected Line Graph
        filename: ref_2b4hhaz8_plot.png
        part: Check graph is similar to expected graph
      _autograder_files:
      - path: /grade/tests/data.csv
        contents: TnVtYmVyIG9mIHRpbWVzIGluIHN0b3JlLEZyZXF1ZW5jeQoxLDMKMiwxMQozLDEyCjQsNwo1LDQK
