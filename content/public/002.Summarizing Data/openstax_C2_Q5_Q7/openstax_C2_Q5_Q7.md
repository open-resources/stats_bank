...
myst:
  substitutions:
    params:
      ...
      df: null
      autograding:
        std_plot: std__9l0c18s_plot.png
        ref_plot: ref_7fg8dekn_plot.png
        csv: |
          Number of times in store,Frequency
          1,4
          2,6
      ...
      - label: Your Line Graph
        filename: std__9l0c18s_plot.png
        part: Check graph is similar to expected graph
      - label: Expected Line Graph
        filename: ref_7fg8dekn_plot.png
        part: Check graph is similar to expected graph
      _autograder_files:
      - path: /grade/tests/data.csv
        contents: TnVtYmVyIG9mIHRpbWVzIGluIHN0b3JlLEZyZXF1ZW5jeQoxLDQKMiw2CjMsMTQKNCw0CjUsNwo=
