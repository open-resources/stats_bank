...
myst:
  substitutions:
    params:
      ...
      - The x-axis should be labeled 'Frequency'.
      - The y-axis should be labeled 'Salary Range'.
      ...
      autograding:
        ...
        density: 5
        horiz: 'True'
        std_plot: std_59qfnc9r_plot.png
        ref_plot: ref_mz_mc8dq_plot.png
      _images:
      - label: Your Bar Plot
        filename: std_59qfnc9r_plot.png
        part: Check graph is similar to expected graph
      - label: Expected Bar Plot
        filename: ref_mz_mc8dq_plot.png
        part: Check graph is similar to expected graph
---
# {{ params.vars.title }}
