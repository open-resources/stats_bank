  ...
  substitutions:
    params:
      ...
      part3:
        ans1:
          value: Stay the Same
          feedback: 'Correct, the new score is exactly 1 standard deviation from the
            old mean so the standard deviation will stay the same (note: this is the
            rarest form of this question and I thought I''d just let you know)'
        ans2:
          value: Not enough information to tell
          feedback: nice try, but there is enough information here
        ans3:
