...
myst:
  substitutions:
    ...
    params_part1_ans3_value: We can see the relative frequencies in the pie chart
    params_part1_ans3_feedback: This is not possible in the pie chart
    ...
    params_part1_ans5_value: The pie chart shows what the highest relative frequency
      is
