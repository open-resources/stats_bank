...
myst:
  substitutions:
    ...
    params_vars_Question: a) Would you expect the number of electronics per household
      to be symmetric, right skewed, or left skewed?
    params_part1_ans1_value: 'Right skewed: The distribution of number of electronicss
      per household is likely right skewed as there is a natural boundary at 0 and
      only a few people have many electronicss.'
    params_part1_ans1_feedback: Correct, awesome work
    params_part1_ans2_value: 'Left skewed: The distribution of number of humans per
      household is likely left skewed as there is a natural boundary at 0 and only
      a few people have many humans.'
    ...
    params_part1_ans3_value: 'Symmetric skewed: The distribution of number of humans
