...
myst:
  substitutions:
    ...
    params_vars_Question: a) Would you expect the distance to the nearest hospital,
      i.e. number of miles between the nearest hospital and home to be symmetric,
      right skewed, or left skewed?
    params_part1_ans1_value: 'Right skewed: The distribution of number of distance
      to the nearest hospital is likely right skewed as there is a natural boundary
      at 0 and only a few people live a very long distance from the nearest hospital.'
    ...
    params_part1_ans2_value: 'Left skewed: The distribution of number of distance
      to the nearest hospital is likely left skewed as there is a natural boundary
      at 0 and only a few people live a very long distance from the nearest hospital.'
    ...
    params_part1_ans3_value: 'Symmetric: The distribution of number of distance to
      the nearest hospital is likely symmetric as there is a natural boundary at 0
      and only a few people live a very long distance from the nearest hospital.'
