...
myst:
  substitutions:
    ...
    params_vars_Question: a) Would you expect the number of plants per household to
      be symmetric, right skewed, or left skewed?
    params_part1_ans1_value: 'Right skewed: The distribution of number of plantss
      per household is likely right skewed as there is a natural boundary at 0 and
      only a few people have many plantss.'
    params_part1_ans1_feedback: Correct, awesome work
    params_part1_ans2_value: 'Left skewed: The distribution of number of hamsters
      per household is likely left skewed as there is a natural boundary at 0 and
      only a few people have many hamsters.'
    ...
    params_part1_ans3_value: 'Symmetric skewed: The distribution of number of hamsters
      per household is likely symmetric as there is a natural boundary at 0 and only
      a few people have many hamsters.'
