...
myst:
  substitutions:
    ...
    params_vars_place: school
    params_vars_thing: plants
    params_vars_Question: a) Would you expect the distance to school, i.e. number
      of miles between school and home to be symmetric, right skewed, or left skewed?
    params_part1_ans1_value: 'Right skewed: The distribution of number of distance
      to school is likely right skewed as there is a natural boundary at 0 and only
      a few people live a very long distance from school.'
    ...
    params_part1_ans2_value: 'Left skewed: The distribution of number of distance
      to school is likely left skewed as there is a natural boundary at 0 and only
      a few people live a very long distance from school.'
    ...
    params_part1_ans3_value: 'Symmetric: The distribution of number of distance to
      school is likely symmetric as there is a natural boundary at 0 and only a few
