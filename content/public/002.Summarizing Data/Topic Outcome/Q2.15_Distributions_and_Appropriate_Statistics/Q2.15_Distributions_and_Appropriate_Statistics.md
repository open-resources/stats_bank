  ...
  substitutions:
    params:
      vars:
        ...
        place: work
        thing: pets
        Question: a) Would you expect the distance to work, i.e. number of miles between
          work and home to be symmetric, right skewed, or left skewed?
      part1:
        ans1:
          value: 'Right skewed: The distribution of number of distance to work is
        ...
        ans2:
          value: 'Left skewed: The distribution of number of distance to work is likely
            left skewed as there is a natural boundary at 0 and only a few people
            live a very long distance from work.'
          feedback: Not quite, the reasoning here is mostly correct, think over what
            it means for a graph to be left skewed
        ans3:
          value: 'Symmetric: The distribution of number of distance to work is likely
            symmetric as there is a natural boundary at 0 and only a few people live
            a very long distance from work.'
          feedback: Not quite, the reasoning here is mostly correct, think over what
