...
myst:
  substitutions:
    ...
    params_part1_ans3_feedback: 'Note: the default number of hours watched in a day
      ...
      lots of TV'
    params_part1_ans4_value: Not enough information to tell
    params_part1_ans4_feedback: nice try, but there is enough information here
---
# {{ params_vars_title }}
