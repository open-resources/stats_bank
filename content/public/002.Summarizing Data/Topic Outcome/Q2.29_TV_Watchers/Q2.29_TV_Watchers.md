...
myst:
  substitutions:
    ...
    params_part1_ans2_value: No, there is not enough information to tell whether the
    ...
    params_part1_ans2_feedback: Not quite, but good try
    ...
    params_part1_ans4_value: 'Yes: the standard deviation being fairly close in size
