...
myst:
  substitutions:
    ...
    params_vars_sample_size: 1371
    params_vars_proportion: 47.0
    params_vars_margin_of_error: 2.64
    params_vars_lower_bound: 44.36
    params_vars_upper_bound: 49.64
    params_vars_margin_of_error_part4: 1.321
    ...
    params_vars_selected_option2: In order to decrease the margin of error to 0.026418991028600947%,
