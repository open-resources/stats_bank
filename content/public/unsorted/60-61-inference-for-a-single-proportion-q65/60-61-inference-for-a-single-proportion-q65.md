...
myst:
  substitutions:
    ...
    params_vars_sample_size: 1287
    params_vars_proportion: 41.0
    params_vars_margin_of_error: 2.69
    params_vars_lower_bound: 38.31
    params_vars_upper_bound: 43.69
    params_vars_margin_of_error_part4: 1.344
    params_vars_selected_option1: If we considered many random samples of 1287 Americans,
