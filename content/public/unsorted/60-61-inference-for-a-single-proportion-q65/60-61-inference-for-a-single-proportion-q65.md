...
myst:
  substitutions:
    ...
    params_vars_sample_size: 1545
    params_vars_proportion: 37.0
    params_vars_margin_of_error: 2.41
    params_vars_lower_bound: 34.59
    params_vars_upper_bound: 39.41
    params_vars_margin_of_error_part4: 1.204
    params_vars_selected_option1: If we considered many random samples of 1545 Americans,
