...
myst:
  substitutions:
    params:
      ...
      part2:
        ans1:
          value: $A$ = 18.0%, $B$ = 16.0%, $C$ = 11.0%
          feedback: Correct!
        ans2:
          value: $A$ = 18.0%, $B$ = 11.0%, $C$ = 16.0%
          feedback: Try again please!
        ans3:
          value: $A$ = 16.0%, $B$ = 18.0%, $C$ = 11.0%
          feedback: Try again please!
        ans4:
          value: $A$ = 16.0%, $B$ = 11.0%, $C$ = 18.0%
          feedback: Try again please!
        ans5:
          value: $A$ = 11.0%, $B$ = 18.0%, $C$ = 16.0%
          feedback: Try again please!
        ans6:
          value: $A$ = 11.0%, $B$ = 16.0%, $C$ = 18.0%
          feedback: Try again please!
      part6:
        ans1:
          value: 'Yes'
