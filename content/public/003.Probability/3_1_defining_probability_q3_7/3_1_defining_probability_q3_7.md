...
myst:
  substitutions:
    params:
      ...
      part2:
        ans1:
          value: $A$ = 24.0%, $B$ = 18.0%, $C$ = 9.0%
          feedback: Correct!
        ans2:
          value: $A$ = 24.0%, $B$ = 9.0%, $C$ = 18.0%
          feedback: Try again please!
        ans3:
          value: $A$ = 18.0%, $B$ = 24.0%, $C$ = 9.0%
          feedback: Try again please!
        ans4:
          value: $A$ = 18.0%, $B$ = 9.0%, $C$ = 24.0%
          feedback: Try again please!
        ans5:
          value: $A$ = 9.0%, $B$ = 24.0%, $C$ = 18.0%
          feedback: Try again please!
        ans6:
          value: $A$ = 9.0%, $B$ = 18.0%, $C$ = 24.0%
          feedback: Try again please!
      part6:
        ans1:
          value: 'Yes'
