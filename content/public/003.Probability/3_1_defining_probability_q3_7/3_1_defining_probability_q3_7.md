...
myst:
  substitutions:
    params:
      ...
      part2:
        ans1:
          value: $A$ = 26.0%, $B$ = 15.0%, $C$ = 9.0%
          feedback: Correct!
        ans2:
          value: $A$ = 26.0%, $B$ = 9.0%, $C$ = 15.0%
          feedback: Try again please!
        ans3:
          value: $A$ = 15.0%, $B$ = 26.0%, $C$ = 9.0%
          feedback: Try again please!
        ans4:
          value: $A$ = 15.0%, $B$ = 9.0%, $C$ = 26.0%
          feedback: Try again please!
        ans5:
          value: $A$ = 9.0%, $B$ = 26.0%, $C$ = 15.0%
          feedback: Try again please!
        ans6:
          value: $A$ = 9.0%, $B$ = 15.0%, $C$ = 26.0%
          feedback: Try again please!
      part6:
        ans1:
          value: 'Yes'
