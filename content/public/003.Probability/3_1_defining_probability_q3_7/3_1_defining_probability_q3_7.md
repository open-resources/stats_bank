...
myst:
  substitutions:
    params:
      ...
      part2:
        ans1:
          value: $A$ = 22.0%, $B$ = 10.0%, $C$ = 16.0%
          feedback: Correct!
        ans2:
          value: $A$ = 22.0%, $B$ = 16.0%, $C$ = 10.0%
          feedback: Try again please!
        ans3:
          value: $A$ = 10.0%, $B$ = 22.0%, $C$ = 16.0%
          feedback: Try again please!
        ans4:
          value: $A$ = 10.0%, $B$ = 16.0%, $C$ = 22.0%
          feedback: Try again please!
        ans5:
          value: $A$ = 16.0%, $B$ = 22.0%, $C$ = 10.0%
          feedback: Try again please!
        ans6:
          value: $A$ = 16.0%, $B$ = 10.0%, $C$ = 22.0%
          feedback: Try again please!
      part6:
        ans1:
          value: 'Yes'
