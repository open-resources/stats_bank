...
myst:
  substitutions:
    params:
      ...
      part2:
        ans1:
          value: $A$ = 26.0%, $B$ = 12.0%, $C$ = 14.0%
          feedback: Correct!
        ans2:
          value: $A$ = 26.0%, $B$ = 14.0%, $C$ = 12.0%
          feedback: Try again please!
        ans3:
          value: $A$ = 12.0%, $B$ = 26.0%, $C$ = 14.0%
          feedback: Try again please!
        ans4:
          value: $A$ = 12.0%, $B$ = 14.0%, $C$ = 26.0%
          feedback: Try again please!
        ans5:
          value: $A$ = 14.0%, $B$ = 26.0%, $C$ = 12.0%
          feedback: Try again please!
        ans6:
          value: $A$ = 14.0%, $B$ = 12.0%, $C$ = 26.0%
          feedback: Try again please!
      part6:
        ans1:
          value: 'Yes'
