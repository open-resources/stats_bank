...
myst:
  substitutions:
    ...
    params_description_num1: 2206
    params_description_num2: 0.44
    params_description_num3: 0.29
    params_description_num4: 0.13
    params_description_num5: 0.31
    params_description_num6: 0.1276
    params_description_num22: 44.0
    params_description_num33: 29.0
    params_description_num44: 13.0
    params_description_num55: 31.0
    params_description_num66: 12.76
    ...
    params_part1_ans2_feedback: Correct! There are voters who are both independent
      and swing voters.
    params_part2_ans1_value: $A$ = 31.0%, $B$ = 13.0%, $C$ = 16.0%
    params_part2_ans1_feedback: Correct!
    params_part2_ans2_value: $A$ = 31.0%, $B$ = 16.0%, $C$ = 13.0%
    params_part2_ans2_feedback: Try again please!
    params_part2_ans3_value: $A$ = 13.0%, $B$ = 31.0%, $C$ = 16.0%
    params_part2_ans3_feedback: Try again please!
    params_part2_ans4_value: $A$ = 13.0%, $B$ = 16.0%, $C$ = 31.0%
    params_part2_ans4_feedback: Try again please!
    params_part2_ans5_value: $A$ = 16.0%, $B$ = 31.0%, $C$ = 13.0%
    params_part2_ans5_feedback: Try again please!
    params_part2_ans6_value: $A$ = 16.0%, $B$ = 13.0%, $C$ = 31.0%
