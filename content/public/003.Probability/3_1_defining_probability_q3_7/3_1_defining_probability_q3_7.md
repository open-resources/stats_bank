...
myst:
  substitutions:
    params:
      ...
      part2:
        ans1:
          value: $A$ = 27.0%, $B$ = 18.0%, $C$ = 10.0%
          feedback: Correct!
        ans2:
          value: $A$ = 27.0%, $B$ = 10.0%, $C$ = 18.0%
          feedback: Try again please!
        ans3:
          value: $A$ = 18.0%, $B$ = 27.0%, $C$ = 10.0%
          feedback: Try again please!
        ans4:
          value: $A$ = 18.0%, $B$ = 10.0%, $C$ = 27.0%
          feedback: Try again please!
        ans5:
          value: $A$ = 10.0%, $B$ = 27.0%, $C$ = 18.0%
          feedback: Try again please!
        ans6:
          value: $A$ = 10.0%, $B$ = 18.0%, $C$ = 27.0%
          feedback: Try again please!
      part6:
        ans1:
          value: 'Yes'
