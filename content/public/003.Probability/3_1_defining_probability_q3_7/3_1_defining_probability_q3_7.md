...
myst:
  substitutions:
    params:
      ...
      part2:
        ans1:
          value: $A$ = 28.0%, $B$ = 12.0%, $C$ = 15.0%
          feedback: Correct!
        ans2:
          value: $A$ = 28.0%, $B$ = 15.0%, $C$ = 12.0%
          feedback: Try again please!
        ans3:
          value: $A$ = 12.0%, $B$ = 28.0%, $C$ = 15.0%
          feedback: Try again please!
        ans4:
          value: $A$ = 12.0%, $B$ = 15.0%, $C$ = 28.0%
          feedback: Try again please!
        ans5:
          value: $A$ = 15.0%, $B$ = 28.0%, $C$ = 12.0%
          feedback: Try again please!
        ans6:
          value: $A$ = 15.0%, $B$ = 12.0%, $C$ = 28.0%
          feedback: Try again please!
      part6:
        ans1:
          value: 'Yes'
