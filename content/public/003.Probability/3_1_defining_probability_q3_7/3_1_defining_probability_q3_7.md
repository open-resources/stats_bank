...
myst:
  substitutions:
    params:
      ...
      part2:
        ans1:
          value: $A$ = 22.0%, $B$ = 17.0%, $C$ = 11.0%
          feedback: Correct!
        ans2:
          value: $A$ = 22.0%, $B$ = 11.0%, $C$ = 17.0%
          feedback: Try again please!
        ans3:
          value: $A$ = 17.0%, $B$ = 22.0%, $C$ = 11.0%
          feedback: Try again please!
        ans4:
          value: $A$ = 17.0%, $B$ = 11.0%, $C$ = 22.0%
          feedback: Try again please!
        ans5:
          value: $A$ = 11.0%, $B$ = 22.0%, $C$ = 17.0%
          feedback: Try again please!
        ans6:
          value: $A$ = 11.0%, $B$ = 17.0%, $C$ = 22.0%
          feedback: Try again please!
      part6:
        ans1:
          value: 'Yes'
