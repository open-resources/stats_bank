...
myst:
  substitutions:
    params:
      ...
      part2:
        ans1:
          value: $A$ = 25.0%, $B$ = 13.0%, $C$ = 12.0%
          feedback: Correct!
        ans2:
          value: $A$ = 25.0%, $B$ = 12.0%, $C$ = 13.0%
          feedback: Try again please!
        ans3:
          value: $A$ = 13.0%, $B$ = 25.0%, $C$ = 12.0%
          feedback: Try again please!
        ans4:
          value: $A$ = 13.0%, $B$ = 12.0%, $C$ = 25.0%
          feedback: Try again please!
        ans5:
          value: $A$ = 12.0%, $B$ = 25.0%, $C$ = 13.0%
          feedback: Try again please!
        ans6:
          value: $A$ = 12.0%, $B$ = 13.0%, $C$ = 25.0%
          feedback: Try again please!
      part6:
        ans1:
          value: 'Yes'
